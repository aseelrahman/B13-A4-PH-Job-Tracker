...
function statusList(){
    const interviewList = document.querySelectorAll('[data-status="interview"]').length
    const rejectList = document.querySelectorAll('[data-status="rejected"]').length
    
    const interviewCount = document.getElementById('interview-count');
    interviewCount.textContent = interviewList;

    const rejectCount = document.getElementById('reject-count');
    rejectCount.textContent = rejectList;
}